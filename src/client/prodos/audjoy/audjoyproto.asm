...
HEADR	= $FCC9
LASTIN	= $2f
TAPEOUT	= $C030	; We're actually co-opting the speaker
...
;---------------------------------------------------------
; aud_receive - Receive a serial packet from the joystick port
...
;---------------------------------------------------------
; aud_send - Send an audio packet out the speaker
; Note - this timing-sensitive routine can't cross a page boundary.
;---------------------------------------------------------
aud_send:
